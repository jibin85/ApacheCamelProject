...
import com.example.fileComponent.transformation.processor.InsuranceMappingFL;
...
public class InsuranceMappingFLTest extends CamelTestSupport {
    @Test
    public void positiveScenario() throws Exception {
        ...
        InsuranceMappingFL insuranceMappingFL = new InsuranceMappingFL();
        insuranceMappingFL.process(defaultExchange);
